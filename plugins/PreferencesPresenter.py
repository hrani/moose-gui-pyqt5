...
class PreferencesPresenter(QObject):
    ...
    def setElectricalPreferences(self):
        ...
        color = QtGui.QColor(r, g, b, a)
        # print(color.name())
        self.view.electricalPeakColorDialog.setCurrentColor(QtGui.QColor(r, g, b, a))
        ...
        color = QtGui.QColor(r, g, b, a)
        # print(color.name())
        self.view.electricalBackgroundColorDialog.setCurrentColor(QtGui.QColor(r, g, b, a))
