...
#from PyQt5.QtWidgets import QGraphicsPixmapItem, QGraphicsWidget,QGraphicsRectItem
...
class KineticsDisplayItem(QGraphicsWidget):
    ...
    def paint(self, painter=None, option=None, widget = None):
        ...
        if self.hasFocus() or self.isSelected():
            painter.setPen(QtGui.QPen(QtGui.QPen(QtCore.Qt.black, 1.8,Qt.DashLine, Qt.RoundCap, Qt.RoundJoin)))
...
class FuncItem(KineticsDisplayItem):
    ...
    def __init__(self, mobj, parent):
        ...
        self.gobj = QGraphicsPixmapItem(QtGui.QPixmap.fromImage(self.funcImage),self.bg)
...
class PoolItem(KineticsDisplayItem):
    ...
    def __init__(self, mobj, parent):
        ...
        self.bg = QGraphicsRectItem(self)
        self.bg.setAcceptHoverEvents(True)
        self.gobj = QGraphicsSimpleTextItem(self.mobj.name, self.bg)
        self.gobj.mobj = self.mobj
        classname = self.mobj.className
        # classname = 'PoolBase'
        ...
        self.bg.setPen(QtGui.QColor(0,0,0,0))
...
class TableItem(KineticsDisplayItem):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.gobj.setPen(QtGui.QPen(QtCore.Qt.black, 2,Qt.SolidLine, Qt.RoundCap, Qt.RoundJoin))
        self.gobj.mobj = self.mobj
...
class EnzItem(KineticsDisplayItem):
    ...
    def __init__(self, *args, **kwargs):
        KineticsDisplayItem.__init__(self, *args, **kwargs)
        self.gobj = QGraphicsEllipseItem(0, 0, 
...
class GRPItem(QGraphicsRectItem):
    ...
    #     if self.isSelected():
    #         drawFocus(painter)
    #         #painter.setPen(QPen(QtGui.QPen(QtCore.Qt.black, 1.8,Qt.Qt.DashLine, Qt.Qt.RoundCap, Qt.Qt.RoundJoin)))
    #         #painter.drawRect(self.boundingRect())
...
if __name__ == '__main__':
    ...
    #item = PoolItem(a)
    #dinfo = (5, 5, QColor('red'), QtGui.QColor('blue'))
